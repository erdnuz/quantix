  ...
  return (
    <BaseDialog onClose={onClose} onReturn={onReturn}>
      <div className="relative flex-1 flex flex-col gap-3">
        ...
        <h2 className="text-2xl font-semibold text-primary-light dark:text-primary-dark text-center">
          Login
        </h2>

        {error && (
          <p className="text-base text-bad text-center">{error}</p>
        )}
        ...
        <button
          className="
            ...
            bg-light dark:bg-dark py-4 px-6 text-base shadow-sm
        ...
        >
          ...
          <span className="text-primary-light dark:text-primary-dark truncate">
        ...
        <div className="ml-1 flex items-center gap-3">
          <input
            id="rememberMe"
            type="checkbox"
            className="h-4 w-4 rounded border-border-light dark:border-border-dark text-accent focus:ring-accent"
            checked={isChecked}
            onChange={handleCheckboxChange}
          />
          <label htmlFor="rememberMe" className="text-sm text-primary-light dark:text-primary-dark">
            Remember me
          </label>
        </div>
      </div>
