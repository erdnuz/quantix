  ...
  return (
    <Link href={`/portfolios/${id}/`} className="block">
      <div className="flex flex-col w-full max-w-[600px] mb-6 p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-300 cursor-pointer bg-white dark:bg-gray-800">
        ...
        {/* Stats row */}
<div className="flex w-full mt-5 gap-4 overflow-x-auto flex-nowrap">
  {Object.entries({
    ...
    <div
      key={columnName}
      className="flex flex-col flex-none items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-lg py-3 px-4 min-w-[80px]"
    >
