...
class CurrencyConverter:
    ...
    def load_rates(self):
        ...
        try:
            with open(self.json_file, 'r') as file:
                ...
                self.last_updated = datetime.strptime(last_updated_str, '%Y-%m-%d %H:%M:%S') if last_updated_str else None
    ...
    def get_exchange_rate(self):
        ...
        if self.currency not in self.exchange_rates:
            try:
                ...
                self.save_rates()  # Save the updated rate to the JSON file
    ...
    def convert(self, amount):
        ...
        if self.currency=="USD":
            return amount
        self.update_rates()  # Ensure rates are updated monthly
