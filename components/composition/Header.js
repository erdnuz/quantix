...
export function Header({ currentUser, openAuth, signOut, openEdit}) {
  ...
  return (
    <header className={styles.header}>
      ...
      <DropdownMenu className={styles.menu} currentUser={currentUser} openAuth={openAuth} signOut={signOut} openEdit={openEdit}/>
      <Login className={styles.search} currentUser={currentUser} openAuth={openAuth} signOut={signOut} openEdit={openEdit}/>
    </header>
  );
};
